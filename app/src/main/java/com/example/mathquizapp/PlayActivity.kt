...
import com.example.mathquizapp.databinding.ActivityPlayBinding
...
class PlayActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnOption1.setOnClickListener {
            ...
            onSelectedOption(binding.btnOption1.text.toString())

        }
        binding.btnOption2.setOnClickListener {

            onSelectedOption(binding.btnOption2.text.toString())

        }
        binding.btnOption3.setOnClickListener {

            onSelectedOption(binding.btnOption3.text.toString())

        }
        binding.btnOption4.setOnClickListener {

            onSelectedOption(binding.btnOption4.text.toString())
    ...
    private fun startTimer() {
        ...
        binding.circularProgressBar.progress = count
